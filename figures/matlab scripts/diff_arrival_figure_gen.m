% Arrival-rate sweep from figures/python figures/sweeps/arrival/arrival.mat
...
addpath(this_dir);
data = load(fullfile(repo_root, 'figures', 'python figures', 'sweeps', 'arrival', 'arrival.mat'));
...
for metric_idx = 1:numel(metric_keys)
    ...
    for alg_idx = 1:numel(algo_keys)
        ...
        plot(arrival_rates, y, '-', 'LineWidth', 2.5, ...
